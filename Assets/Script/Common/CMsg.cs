...
namespace Tools
{
    public class CMsg
    {
        public struct SMsgHeader
        {
            ...
            public UInt32 n64Reserve;
        };

        public static Int32 s_n32MsgHeaderSize = 16;
        ...
        private void UpdateMsgSize()
        {
            ...
            n32MsgSize = IPAddress.HostToNetworkOrder(n32MsgSize);
            byte[] arrByteStream = BitConverter.GetBytes(n32MsgSize);
            this.m_cnbBuffer.ReWrite(n32ProtocalIDSize, arrByteStream, (Int32)n32ProtocalIDSize);
        }
        ...
        {
            Int32 n32ProtocalIDSize = sizeof(Int32);
            n32ProtocalID = IPAddress.HostToNetworkOrder(Convert.ToInt32(n32ProtocalID));
            byte[] arrByteStream = BitConverter.GetBytes(n32ProtocalID);
            this.m_cnbBuffer.ReWrite((Int32)0, arrByteStream, (Int32)n32ProtocalIDSize);
        }
